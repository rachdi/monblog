  ...
  window.plugins.radar = {
    ...
    emit: function(div, item) {
      return wiki.getScript('/js/d3/d3.min.js', function() {
        var angle, c, candidates, centerXPos, centerYPos, circleAxes, circleConstraint, colorSelector, comments, complete, d, data, dimension, each, fill, h, heightCircleConstraint, hours, j, k, keys, l, lastThumb, len, len1, limit, limitsFromData, lineAxes, m, max, maxVal, merged, merging, minVal, n, o, p, parseText, percents, q, radialTicks, radius, radiusLength, ref, ref1, ref2, results, rotate, rows, ruleColor, series, translate, value, viz, vizBody, vizPadding, w, who, widthCircleConstraint;
        ...
        percents = function(obj) {
          ...
          for (p = 0, len3 = ref.length; p < len3; p++) {
            k = ref[p];
            results.push(100.0 * value(obj[k]) / limit[k]);
          }
          return results;
        };
        ...
        hours = (function() {
          results = [];
          for (var q = 0, ref2 = dimension - 1; 0 <= ref2 ? q <= ref2 : q >= ref2; 0 <= ref2 ? q++ : q--){ results.push(q); }
          return results;
        }).apply(this);
        minVal = 0;
        maxVal = 100;
